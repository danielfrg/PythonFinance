...
class FileManagerTest(unittest.TestCase):
    ...
    def test_get_filenames(self):
        ...
        ans = self.fm.get_filenames(symbols[0], start_date, end_date, downloadMissing=False)
        self.assertEqual(ans, [])

        # Test: return None on missing file and downloadMissing=False and ignoreMissing=False
        ans = self.fm.get_filenames(symbols[0], start_date, end_date, downloadMissing=False, ignoreMissing=False)
        self.assertEqual(ans, None)

        # Test: Download file and test name
        ans = self.fm.get_filenames(symbols[0], start_date, end_date, downloadMissing=True)
        ...
        ans = self.fm.get_filenames(symbols, start_date, end_date, downloadMissing=True)
        ...
        symbols = ["AAPL","FAKE1","GLD","FAKE1","GOOG","SPY","XOM","FAKE1"]
        ans = self.fm.get_filenames(symbols, start_date, end_date, downloadMissing=True, ignoreMissing=False)
